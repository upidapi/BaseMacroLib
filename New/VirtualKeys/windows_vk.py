...
class WindowsVk(BaseVk):
    """
    enum of virituall keys for windows
    """
    ms_l = mouse_left = 1
    ms_r = mouse_right = 2
    cancel = 3
    ...
    # The <> keys on the US standard keyboard, or the \| key
    # on the non-US 102-key keyboard
    oem_102 = 226
...
#     key: val for key, val in WindowsVk.__dict__.items()
