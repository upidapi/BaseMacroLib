...
#       data_files=[
#           ('Lib/site-packages/pyWinhook', ['pyWinhook/cpyHook.py', 'LICENSE.txt', 'README.txt', 'CHANGELOG.txt'])],
#       keywords='hook win32 win64 keyboard input user control'
#       )

setup(
    name='myPyWinhook',
    py_modules=["cpyHook.py"],
    ext_modules=[
        Extension(
            'pyWinhook._cpyHook',
            ['pyWinhook/cpyHook.i'],
...
# note: make sure you're in the "\pyWinhook-master" dir

# run "swig -python .\pyWinhook\cpyHook.i"
# to compile the c code

# run "python setup.py build_ext --inplace"
# to compile it to a lib
